            ...
            <div class="card-body rtl">
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        ...
                        <input type="text" pattern="[\D]+" class="form-control" name="vFirstName" id="vName" placeholder="First Name" required>
                    </div>

                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        <label for="vLastName">نام خانوادگی<span class="text-danger"> *</span></label>
                        <input type="text" pattern="[\D]+" class="form-control" name="vLastName" id="vLastName" placeholder="Last Name" required>
                    </div>

                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        <label for="vContactNo">تلفن تماس<span class="text-danger"> *</span></label>
                        <input type="text" pattern="[0-9]{1,}" class="form-control" name="vContactNo" placeholder="Phone" required>
                    </div>

                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        <label for="vEmail">آدرس ایمیل<span class="text-danger"> *</span></label>
                        <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
                               class="form-control" name="vEmail" id="vEmail" placeholder="Email" required>
                    ...
                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        ...
                        id="vPassword" placeholder="Password Label" title="Six or more characters" required>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        ...
                        <select class="custom-select" name='iGroupId' id="iGroupId" required>
                            ...
                            @foreach($groups as $group)
                                <option value="{{$group['iGroupId']}}">{{$group['vGroup']}}</option>
                            @endforeach
                        </select>
                    </div>
                    {{--@endif--}}
                    ...
                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        ...
                        <select class="custom-select" name="area" id="area" required>
                            ...
                            @foreach($areas as $area)
                                <option value="{{$area['aId']}}">{{$area['sAreaNamePersian']}} - {{$area['sAreaName']}}</option>
                            @endforeach
                        </select>
                    </div>
