...
@section('content')
    <div class="card p-4">
        <div class="card-body rtl">
            <form id="vehicle-form" method="post" action="{{url('vehicles.store')}}">

                <input type="hidden" id="usertype" name="usertype" value="driver"/>
                <div class="form-row">

                    <div class="col-12"><h3>افزودن وسیله نقلیه جدید</h3></div>
                    ...
                    <div class="col-12 col-md-4 mb-3 form-group">
                        <label for="licencePlate" class="w-100">پلاک خودرو <span class="text-danger"> *</span></label>
                        <div id="licencePlate" class="input-group ltr">
                            ...
                            <input type="text" class="form-control text-center" name="vLicencePlate_place2"
                                    ...
                                    placeholder="000" required maxlength="3">
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <div class="table-responsive">
                            <div class="btn-group btn-group-toggle ltr align-middle" data-toggle="buttons">
                    ...
                    <div class="col-12 col-md-6 mb-2">
                        <a href="#" class="btn btn-success btn-block" id="submit-form">ثبت اطلاعات</a>
                    </div>
