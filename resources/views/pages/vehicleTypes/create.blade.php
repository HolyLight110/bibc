        ...
        <div class="card-body rtl">
            ...
            <form action="{{url('vehicleTypes.store')}}" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="col-12"><h3>افزودن نوع خودرو جدید</h3></div>
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mb-3 form-group">
                        <label for="form-item6">کمیسیون <span class="text-danger">*</span></label>
                        <div class="input-group ltr">
                            <div class="input-group-prepend">
                                <span class="input-group-text text-center d-inline" style="min-width: 45px">%</span>
                            </div>
                            <input type="text" class="form-control" placeholder="" name="form-item6">
                        </div>
                    </div>

                    <div class="col-12 col-md-6 col-xl-4 mb-3 form-group">
                        <label for="form-item7">ظرفیت <span class="text-danger">*</span></label>
                        <div class="input-group ltr">
                            <div class="input-group-prepend">
                                <span class="input-group-text text-center d-inline" style="min-width: 45px"><i class="fa fa-users"></i></span>
                            </div>
                            <input type="text" class="form-control" placeholder="" name="form-item7">
                        </div>
                    </div>

                    <div class="col-12 col-md-6 col-xl-4 mb-3 form-group">
                        <label for="form-item8">نوع خودرو <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="" name="form-item8">
                    </div>
