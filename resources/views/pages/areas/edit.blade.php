...
@section('content')
    <div class="form-row">
        <div class="col-12 mb-2">
            <form method="post" action="{{url('areas.update',['id'=>$area['aId']])}}" enctype="multipart/form-data">

                <input type="hidden" name="iAdminId" value="{{$area['aId']}}"/>
                <input type="hidden" name="mapCenter" id="mapCenter" />
                <input type="hidden" name="mapZoom" id="mapZoom" value="{{$area->mapZoom}}"/>
                ...
                <div class="card p-4">
                    <div class="card-body rtl">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12"><h3>ویرایش مشخصات منطقه</h3></div>
                            ...
                            <div class="col-12 col-md-6 mb-3 form-group">
                                ...
                                <select class="custom-select form-control-select" name='sSpecialArea' id="radius-id"
                                        required>
                            ...
                            <div class="col-12 col-md-6 mb-3 form-group">
                                ...
                                <select class="custom-select form-control-select" name='sActive' id="radius-id" required>
                            ...
                            <div class="col-12 mb-2 w-100"></div>
                            <textarea style="display:none;" class="form-control col-12 mb-2"
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <a href="{{url('areas')}}" class="btn btn-block btn-secondary">لغو</a>
                            </div>
        ...
        <div class="col-12">
            <div class="card p-4">
                <div class="card-body">
                    ...
                    <input type="button" class="btn btn-info" value="بروز رسانی نقشه" id="resetMap">
                    <hr>
