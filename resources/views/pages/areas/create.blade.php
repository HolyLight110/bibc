...
@section('content')
    <div class="form-row">
        <div class="col-12 mb-2">
            <form method="post" action="{{url('areas.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-md-6 mb-3 form-group">
                                ...
                                <select class="custom-select form-control-select" name='sSpecialArea' id="radius-id"
                                        required>
                                    <option value="No">منطقه
                                        مخصوص
                                    </option>
                                    <option value="Yes">منطقه
                                        عادی
                                    </option>
                                </select>
                            </div>
                            ...
                            <textarea style="display:none;" class="form-control col-12 mb-3"
                            id="sFeatureCollection"
                            name="sFeatureCollection"></textarea>
